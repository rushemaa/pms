            ...
            <div class="tab-content" id="nav-tabContent">
                <div id="nav-tab">
                    <ul>
                        ...
                        <li><a href="register-ngo-step2?id=<?=$id_hash?>">Additional Info</a></li>
                ...
                <div class="tab-content-body">
                 ...
                 <div class="form-group">
                  ...
                  <input type="hidden" name="institution" value="<?=$Hash->decrypt($_GET['id'])?>">
                  <div class="form-group">
                  ...
                  <div class="pull-right">
                    <a class="btn" href="register-ngo-step2?id=<?=$id_hash?>" style="color: white">Previous</a>
