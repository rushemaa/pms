                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    <thead>
                      ...
                      <tbody><?php $st4 = $database->query("SELECT  * from institution_details WHERE status=1 ORDER BY id DESC");
                        ...
                        foreach ($st4 as $key => $value) {?>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="display?id=<?=$value['id']?>"><input class="btn btn-primary update" type="submit" value="View More" name="" data-id=<?=$Hash->encrypt($value['id'])?>></a></td>
                                        </tr>
                        <?php } ?>                
                                    </tbody>
                  </table>
